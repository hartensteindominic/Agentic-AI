...
- Cinematic dashboard with KPI cards, trajectory visualization, weekly plan cards, contextual recommendations, and a four-agent planning council.
- Self-contained static app with a small Node test suite for the forecasting engine and agent outputs.
